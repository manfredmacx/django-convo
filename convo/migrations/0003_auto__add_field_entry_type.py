...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.type'
        db.add_column('convo_entry', 'type', self.gf('django.db.models.fields.CharField')(default='ALL', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.type'
        db.delete_column('convo_entry', 'type')
