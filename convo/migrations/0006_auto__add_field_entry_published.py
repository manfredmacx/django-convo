...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		db.add_column('convo_entry', 'published', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
		for convo in orm.Entry.objects.all():
			convo.published = True
			convo.save()
	...
	models = {
		...
		'convo.entry': {
			...
			'original': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'original_entry'", 'null': 'True', 'to': "orm['convo.Entry']"}),
			...
			'url_if_anonymous': ('django.db.models.fields.URLField', [], {'max_length': '1000', 'null': 'True'})
		}
	}
